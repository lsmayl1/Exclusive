  ...
  const Categories = [
    {
      ...
      svg: (
        <svg
          className="stroke-current text-black group-hover:text-white "
          width="56"
          height="56"
          viewBox="0 0 56 56"
          fill="none"
