      ...
      <div className="w-full h-[500px] bg-black flex box-border justify-between ">
        <div className="flex  p-[56px] w-[600px] h-[500px] ">
			<div className="flex flex-col justify-between">
				<h1 className="font-poppins font-semibold text-00FF66">Categories</h1>
				<h1 className="font-inter font-semibold text-white text-[36px]">Enhance Your Music Experience</h1>
			...
			<button className="bg-00FF66 w-[171px]  h-[56px] rounded-[4px] font-poppins font-medium text-white ">Buy Now!</button>
			</div>
