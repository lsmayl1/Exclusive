  ...
  return (
    <div className="container flex mt-[140px] justify-center gap-[95px]">
      <div className="flex flex-col justify-center items-center text-center gap-[24px] ">
        ...
        <div>
          <h1 className="text-black font-poppins font-semibold text-[20px]">
